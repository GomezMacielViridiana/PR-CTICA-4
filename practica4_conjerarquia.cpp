...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-24.0f, 18.0f, 7.0f));
		...
		model = glm::translate(model, glm::vec3(-24.0f, 18.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		...
		//dibuja cubo, pirámide triangular, pirámide base cuadrangular
